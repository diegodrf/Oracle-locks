...
dpkg -i /app/tmp/oracle-instantclient11.2-basic_11.2.0.4.0-2_amd64.deb && \
dpkg -i /app/tmp/oracle-instantclient11.2-devel_11.2.0.4.0-2_amd64.deb && \
dpkg -i /app/tmp/oracle-instantclient11.2-sqlplus_11.2.0.4.0-2_amd64.deb && \
